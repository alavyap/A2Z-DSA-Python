'''
LeetCode :> https://www.naukri.com/code360/problems/intersection-of-linked-list_630457?interviewProblemRedirection=true&search=Linked%20List
Coding Ninjas :> https://leetcode.com/problems/intersection-of-two-linked-lists/description/
...
# Brute Force 
def intersectional(headA,headB):
    '''
    if (headA is  None or headA.next is None) or (headB is None or headB.next is None ) : 
        return None 
    tempA = headA
    tempB = headB 
